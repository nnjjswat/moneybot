...
function process_player_cashout(data) { 
	...
	if (cashed_out == true ) { 
		...
		if (cur_random >= 94) { 
			...
			cashouttarget = gamedata.table_total * 1.7; 
		...
		cashouttarget = cashouttarget * engine.getCurrentPayout() + (highestbet * 1.27); 
...
function process_crash(data) { 
	...
	// 	// 	// }
	// 	// }
// YOUR STARTING BALANCE IS 343482
